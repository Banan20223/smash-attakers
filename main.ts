...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    [img`
        ...
        9 . 9 9 9 9 9 9 9 9 9 9 9 9 9 9 
        9 . 9 9 9 9 3 3 3 3 9 9 9 9 9 9 
        9 9 9 9 9 3 f 3 3 f 3 9 9 9 9 9 
        9 f e e 3 3 f 3 3 f 3 3 e e 9 9 
        9 9 f e e 3 3 3 3 3 3 3 e f 9 9 
        9 9 9 f e e 4 4 4 4 e e f . 9 9 
        9 9 9 4 f 2 2 2 2 2 2 f 4 e 9 9 
        9 9 4 d f 2 2 2 2 2 2 f d 4 9 9 
        9 9 4 4 f 4 4 5 5 4 4 f 4 4 9 . 
        ...
        2 2 2 f f f 2 2 2 2 f f f . 2 2 
        2 2 2 2 f e e e e e e f f f 2 2 
        2 . f f e 2 2 2 2 2 2 e e f 2 2 
        2 2 f e 2 f f f f f f 2 e f f 2 
        2 2 f f f f e e e e f f f f f 2 
        2 . f e f b f 4 4 f b f e f 2 2 
        2 . f e 4 1 f d d f 1 4 e f . 2 
        2 2 . f e 4 d d d d 4 e f e 2 2 
        2 2 f e f 2 2 2 2 e d d 4 e 2 2 
        2 2 e 4 f 2 2 2 2 e d d e 2 2 . 
        2 2 2 . f 4 4 5 5 f e e . 2 2 2 
        2 2 2 2 f f f f f f f . 2 2 2 . 
        . 2 2 2 f f f . . . . 2 2 . . . 
        `,img`
        . . . . . . f f f f . . . . . . 
        . 1 . . f f f 2 2 f f f . . 1 1 
        . 1 . f f f 2 2 2 2 f f f . 1 1 
        1 1 f f f e e e e e e f f f 1 1 
        1 . f f e 2 2 2 2 2 2 e e f 1 . 
        1 1 f e 2 f f f f f f 2 e f 1 1 
        1 . f f f f e e e e f f f f . 1 
        1 f f e f b f 4 4 f b f e f f 1 
        1 f e e 4 1 f d d f 1 4 e e f 1 
        1 . f e e d d d d d d e e f . 1 
        1 1 . f e e 4 4 4 4 e e f . 1 1 
        1 1 e 4 f 2 2 2 2 2 2 f 4 e 1 . 
        1 1 4 d f 2 2 2 2 2 2 f d 4 1 1 
        1 1 4 4 f 4 4 5 5 4 4 f 4 4 1 1 
        1 1 . . . f f f f f f . 1 1 . . 
        1 1 1 1 . f f . . f f 1 1 1 . . 
        `,img`
        . . . . . . . . . . . . . . . . 
        . . . . . . f f f f . . . . . . 
        . . . . f f f 2 2 f f f . . . . 
...
let Smash_Guy: Sprite = null
let Ghost: Sprite = null
let Smash_Attaker: Sprite = null
info.startCountdown(100)
info.setLife(100)
Smash_Attaker = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
    . . f f f e e e e e e f f f . . 
...
scene.setBackgroundImage(img`
    ...
    `)
controller.moveSprite(Smash_Attaker, 100, 100)
forever(function () {
    music.play(music.stringPlayable("E C5 G C F B A D ", 125), music.PlaybackMode.UntilDone)
})
forever(function () {
    controller.moveSprite(Smash_Guy, 100, 100)
})
forever(function () {
    Ghost = sprites.createProjectileFromSide(img`
        ...
        ....aa............aaa...
        ..aaaaa..........aaaaaaa
        .aaaaaaa..ffff...aaa.aaa
        .aaaaaaaff1111ff.aaa.aaa
        aaaaaaaab111111bfaaaaaaa
        aaaaaaaf11111111f.aaaaaa
        aaaaaaad11111111dfaaaaaa
        aaaaaaad11111111daaaaaa.
        aaaaaafddd1111dddaaaaaa.
        a..aaafbdbfddfbdbaaaaaa.
        ....aafcdcf11fcdcaaaa.a.
        ....a..fb111111bf.aa.aa.
        ......fffcdb1bdffff..a..
        ....fc111cbfbfc111cf....
...
forever(function () {
    ...
    [img`
        ...
        ..aaaa.............aaaaa
        .aaaaa....ffff....aaaaaa
        .aaaaa..ff1111ff..aaaaaa
        .aaaaa.f31111113f..aaaa.
        .aaaaa.f11111111f..aaaa.
        ..aaaafd11111111df.aaa..
        ..aaa.fd11111111df.aaa..
        ...aaafddd1111dddfaaa...
        ...aaafbdbfddfbdbfaaa...
        ...aaafcdcf11fcdcfaaa...
        ....aa.fb111111bf.......
